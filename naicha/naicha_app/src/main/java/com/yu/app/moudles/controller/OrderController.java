...
//        payData.put("notify_url", Const.PayJS.notifyUrl);
//        payData.put("callback_url", "https://localhost:8101/naicha_ui");
//        payData.put("auto", "1");
//        payData.put("hide", "1");
//        payData.put("sign", PayjsUtil.sign(payData));
//        return Result.ok(Const.PayJS.cashierUrl + "?" + HttpUtil.toQueryStr(payData));
        orderInfo.setPayTime(new Date());
        orderInfo.setPayjsOrderId("2021082222181000607237773");
        orderInfo.setWxPayTransactionId("4200001165202108227210944399");
        orderInfo.setPayPrice(orderInfo.getTotalPrice());
